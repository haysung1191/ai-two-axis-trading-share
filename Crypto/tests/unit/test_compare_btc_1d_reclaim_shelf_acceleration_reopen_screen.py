...
from scripts.compare_btc_1d_reclaim_shelf_acceleration_reopen_screen import build_report_from_batch


def test_reclaim_shelf_acceleration_reopen_screen_promotes_candidate_stage_seed() -> None:
    batch = {
        "run_id": "demo",
...
def test_reclaim_shelf_acceleration_reopen_screen_prefers_clean_stage2_progress_variant() -> None:
    batch = {
        "run_id": "demo",
        "stage1_survivors": ["a", "b"],
        "results": [
