...
from scripts.compare_btc_1d_momentum_burst_shallow_reclaim_reopen_screen import build_report_from_batch


def test_momentum_burst_shallow_reclaim_reopen_screen_promotes_candidate_stage_seed() -> None:
    batch = {
        "run_id": "demo",
...
def test_momentum_burst_shallow_reclaim_reopen_screen_keeps_search_open_when_bar_not_cleared() -> None:
    batch = {
        "run_id": "demo",
        "stage1_survivors": ["a"],
        "results": [
...
def test_momentum_burst_shallow_reclaim_reopen_screen_prefers_clean_stage2_progress_variant() -> None:
    batch = {
        "run_id": "demo",
        "stage1_survivors": ["a", "b"],
        "results": [
