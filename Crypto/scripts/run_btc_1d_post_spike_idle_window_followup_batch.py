...
FOLLOWUP_VARIANT_LABELS: tuple[str, ...] = (
    "trend9504_depth055_volume100_hold36",
    "trend9504_depth055_volume104_hold36",
    "trend9504_depth055_volume100_stop22_hold36",
    "trend9504_depth055_volume100_hold32",
    "trend1056_depth055_volume100_hold36",
    "trend1056_depth055_volume104_hold36",
    "trend1056_depth055_volume100_stop22_hold36",
    "trend1056_depth055_volume100_hold32",
)
...
def main() -> int:
    ...
    result = service.run_batch(
        Btc1dPostSpikeConsolidationBreakoutWalkForwardRepairConfig(
            variant_labels=FOLLOWUP_VARIANT_LABELS,
    ...
    print(
        json.dumps(
            {
                "artifact_stem": "btc_1d_post_spike_idle_window_followup_batch",
                "variant_labels": list(FOLLOWUP_VARIANT_LABELS),
                "result": result,
            },
            indent=2,
        )
