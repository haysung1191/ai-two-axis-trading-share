...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run BTCUSDT 1d paper validation for the pullthrough asymmetric release candidate."
    )
...
def parse_args(argv: list[str] | None = None) -> BtcPaperValidationConfig:
    ...
    return BtcPaperValidationConfig(
        ...
        hypothesis="BTCUSDT 1d pullthrough asymmetric release candidate aims to convert the defensive hold reframe into a clean attack-capable candidate.",
        ema_fast_window=20,
        ema_slow_window=50,
        atr_window=14,
        atr_multiple=3.5,
        ...
        extra_parameters={
            ...
            "setup_close_strength_threshold": 0.72,
