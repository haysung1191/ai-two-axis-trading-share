...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run BTC 1d walk-forward diagnostic for the volatility expansion reclaim cooldown plateau-112 candidate.")
...
def parse_args(argv: list[str] | None = None) -> Btc1dWalkForwardDiagnosticConfig:
    ...
    return Btc1dWalkForwardDiagnosticConfig(
        ...
        candidate_label="volatility_expansion_reclaim_cooldown_plateau112",
        extra_parameters={
            "trend_ema_window": 84,
            "breakout_window": 18,
            "atr_window": 11,
