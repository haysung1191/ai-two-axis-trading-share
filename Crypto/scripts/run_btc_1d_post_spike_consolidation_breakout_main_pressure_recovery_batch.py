...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run BTC 1d post-spike consolidation breakout main-pressure recovery batch."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    service = Btc1dPostSpikeConsolidationBreakoutMainPressureRecoveryBatchService(
