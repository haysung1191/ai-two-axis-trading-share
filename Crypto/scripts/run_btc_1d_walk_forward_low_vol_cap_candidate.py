...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run BTC 1d walk-forward diagnostic for the low-volatility cap candidate.")
...
def parse_args(argv: list[str] | None = None) -> Btc1dWalkForwardDiagnosticConfig:
    ...
    return Btc1dWalkForwardDiagnosticConfig(
        ...
        candidate_label="low_vol_cap_050_025_minvol020",
        extra_parameters={
