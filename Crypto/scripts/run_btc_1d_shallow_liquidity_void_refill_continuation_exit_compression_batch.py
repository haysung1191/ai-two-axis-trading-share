...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run BTC 1d shallow liquidity void refill continuation exit compression batch.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    config = Btc1dShallowLiquidityVoidRefillContinuationExitCompressionConfig(
        symbol=args.symbol,
    ...
    result = Btc1dShallowLiquidityVoidRefillContinuationExitCompressionBatchService(analysis_results_dir=args.analysis_dir).run_batch(config)
