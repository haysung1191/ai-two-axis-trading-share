...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the BTC 1d trend dip reversal breakout exit symmetry batch.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = Btc1dTrendDipReversalBreakoutExitSymmetryBatchService(analysis_results_dir=args.analysis_dir).run_batch(config)
