...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run BTC 1d pullthrough candidate structural-repair walk-forward batch."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    service = Btc1dPullthroughCandidateStructuralRepairBatchService(analysis_results_dir=args.analysis_dir)
