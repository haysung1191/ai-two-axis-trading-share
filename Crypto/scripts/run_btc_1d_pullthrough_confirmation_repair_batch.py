...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run BTC 1d pullthrough confirmation repair batch."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    service = Btc1dPullthroughConfirmationRepairBatchService(analysis_results_dir=args.analysis_dir)
