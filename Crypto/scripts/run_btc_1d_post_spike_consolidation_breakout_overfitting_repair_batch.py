...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run BTC 1d post-spike consolidation breakout overfitting-repair batch from the fresh-seed slower_trend anchor."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    service = Btc1dPostSpikeConsolidationBreakoutOverfittingRepairBatchService(
