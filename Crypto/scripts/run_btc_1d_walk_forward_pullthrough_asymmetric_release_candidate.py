...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run BTC 1d walk-forward diagnostic for the pullthrough asymmetric release candidate."
    )
...
def parse_args(argv: list[str] | None = None) -> Btc1dWalkForwardDiagnosticConfig:
    ...
    return Btc1dWalkForwardDiagnosticConfig(
        ...
        candidate_label="pullthrough_asymmetric_release_tighter_exit",
        extra_parameters={
            "trend_ema_window": 72,
            "breakout_window": 18,
            "atr_window": 14,
