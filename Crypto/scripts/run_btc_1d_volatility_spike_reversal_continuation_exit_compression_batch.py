...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the BTC 1d volatility spike reversal continuation exit-compression batch.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = Btc1dVolatilitySpikeReversalContinuationExitCompressionBatchService(analysis_results_dir=args.analysis_dir).run_batch(config)
