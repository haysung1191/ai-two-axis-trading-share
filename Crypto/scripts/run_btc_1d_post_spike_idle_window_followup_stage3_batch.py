...
STAGE3_VARIANT_LABELS: tuple[str, ...] = (
    "trend1056_depth055_volume104_stop22_hold36",
    "trend1056_depth055_volume108_stop22_hold36",
    "trend1056_depth0605_volume104_stop22_hold36",
    "trend1056_depth055_volume104_stop24_hold36",
    "trend1056_depth055_volume104_stop22_hold40",
)
...
def main() -> int:
    ...
    result = service.run_batch(
        Btc1dPostSpikeConsolidationBreakoutWalkForwardRepairConfig(
            variant_labels=STAGE3_VARIANT_LABELS,
            artifact_stem="btc_1d_post_spike_idle_window_followup_stage3_batch",
        )
    )
    print(
        json.dumps(
            {
                "artifact_stem": "btc_1d_post_spike_idle_window_followup_stage3_batch",
                "variant_labels": list(STAGE3_VARIANT_LABELS),
                "result": result,
            },
            indent=2,
        )
