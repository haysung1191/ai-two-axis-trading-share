...
from app.domains.experiments.btc_1d_adx_breakout_trend_high_cagr_batch import (
    Btc1dAdxBreakoutTrendHighCagrBatchService,
    Btc1dAdxBreakoutTrendHighCagrConfig,
)


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the BTC 1d ADX breakout trend high-CAGR batch.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = Btc1dAdxBreakoutTrendHighCagrBatchService(analysis_results_dir=args.analysis_dir).run_batch(config)
