...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run BTC 1d post-spike consolidation breakout main-pressure entry timing batch."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    service = Btc1dPostSpikeConsolidationBreakoutMainPressureEntryTimingBatchService(
