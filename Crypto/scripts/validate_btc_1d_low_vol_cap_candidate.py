...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run BTCUSDT 1d paper validation for the promoted low-volatility cap candidate.")
...
def parse_args(argv: list[str] | None = None) -> BtcPaperValidationConfig:
    ...
    return BtcPaperValidationConfig(
        ...
        hypothesis="BTCUSDT 1d trend following survives paper-validation when low-volatility exposure is capped instead of blocking entries.",
        ema_fast_window=20,
        ema_slow_window=50,
        atr_window=14,
        atr_multiple=3.5,
        ...
        extra_parameters={
            ...
            "cooldown_bars": 0,
            "low_volatility_cap_threshold": 0.50,
