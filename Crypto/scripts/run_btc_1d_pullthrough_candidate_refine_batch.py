...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run BTC 1d pullthrough candidate refinement batch around stronger_setup_076."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    service = Btc1dPullthroughCandidateRefineBatchService(analysis_results_dir=args.analysis_dir)
